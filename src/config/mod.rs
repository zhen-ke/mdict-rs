...
pub const MDX_FILES: &[&str] = &[
    // "/Users/ke/Documents/rust-mdx-server/dicts/LDOCE5++V2-15.mdx",
    "/Users/ke/Documents/rust-mdx-server/dicts/朗文当代高级英语词典6th.mdx",
    "/Users/ke/Documents/rust-mdx-server/dicts/朗文当代高级英语词典6th.mdd",
];
...
pub static MDX_RESOURCES: LazyLock<HashMap<String, MdxReader>> = LazyLock::new(|| {
    info!("initializing mdx resources...");
